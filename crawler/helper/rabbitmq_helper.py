...
class RabbitMQManager:
    ...
    def connect(self):
        ...
        try:
            ...
            # Declare queue (durable = survive RabbitMQ restart)
    ...
    def consume(self, callback, auto_ack=False):
        ...
        Args:
            callback: Function to call for each message (receives ch, method, properties, body)
            auto_ack: If True, automatically acknowledge messages (not recommended)
        """
        try:
